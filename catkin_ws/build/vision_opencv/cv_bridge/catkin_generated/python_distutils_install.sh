...
echo_and_run cd "/home/charl/catkin_ws/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/charl/catkin_ws/src/vision_opencv/cv_bridge/setup.py" \
     \
    build --build-base "/home/charl/catkin_ws/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
